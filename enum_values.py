...
ordering = {
	"Uploaded newest" : "&priord=2",
	"Uploaded oldest" : "&priord=3",
	"Trackname alphabetical" : "&priord=0",
	"Authorname alphabetical" : "&priord=1",
	"Updated newest" : "&priord=4",
	"Updated oldest" : "&priord=5",
	"Activity most recent" : "&priord=6",
	"Activity least recent" : "&priord=7",
	"Awards most" : "&priord=8",
	"Awards least" : "&priord=9",
	"Comments most" : "&priord=10",
	"Comments least" : "&priord=11",
	"Difficulty easiest" : "&priord=12",
	"Difficulty hardest" : "&priord=13",
	"Length shortest" : "&priord=14",
	"Length longest" : "&priord=15",
	"Trackvalue lowest" : "&priord=24",
	"Trackvalue highest" : "&priord=25",
	"Onlinerating MXKarma lowest" : "&priord=26",
	"Onlinerating MXKarma highest" : "&priord=27",
}
